...
# Constants
PERPLEXITY_MODEL = MODELS.get('perplexity', {}).get('id', os.environ.get('PERPLEXITY_MODEL', 'sonar-pro'))
PERPLEXITY_MAX_TOKENS = int(MODELS.get('perplexity', {}).get('max_tokens', os.environ.get('PERPLEXITY_MAX_TOKENS', '2000')))
PERPLEXITY_TEMPERATURE = float(MODELS.get('perplexity', {}).get('temperature', os.environ.get('PERPLEXITY_TEMPERATURE', '0.2')))
